...
ActiveRecord::Schema[8.0].define(version: 2025_10_03_212122) do
  ...
  create_table "chamados", force: :cascade do |t|
    ...
    t.index ["funcionario_id"], name: "index_chamados_on_funcionario_id"
  end
  ...
  add_foreign_key "chamados", "funcionarios"
end
