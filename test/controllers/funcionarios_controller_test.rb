...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference("Funcionario.count") do
      post funcionarios_url, params: { funcionario: { cargo: @funcionario.cargo, data_admissao: @funcionario.data_admissao, departamento: @funcionario.departamento, email: @funcionario.email, nome: @funcionario.nome, salario: @funcionario.salario, status: @funcionario.status, telefone: @funcionario.telefone } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { cargo: @funcionario.cargo, data_admissao: @funcionario.data_admissao, departamento: @funcionario.departamento, email: @funcionario.email, nome: @funcionario.nome, salario: @funcionario.salario, status: @funcionario.status, telefone: @funcionario.telefone } }
